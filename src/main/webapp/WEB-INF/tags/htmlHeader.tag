...
<%--
Foorder :: a Spring Framework demonstration
--%>
...
<head>
    ...
    <title>Foorder G3.6</title>

    <%-- CSS generated from LESS --%>
    <spring:url value="/resources/css/foorder.css" var="foorderCss"/>
    <link href="${foorderCss}" rel="stylesheet"/>
